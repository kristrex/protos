...
type RegisterRequest struct {
	...
	Email         string                 `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`                       // Почта
	Goal          string                 `protobuf:"bytes,4,opt,name=goal,proto3" json:"goal,omitempty"`                         // Цель: model/scout
	Password      string                 `protobuf:"bytes,5,opt,name=password,proto3" json:"password,omitempty"`                 // Пароль
...
func (x *SessionRequest) GetAccessToken() string {
	if x != nil {
		return x.AccessToken
	}
	return ""
...
func (x *SessionResponse) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *SessionResponse) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
func (x *SessionResponse) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
type ChangePasswordRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AccessToken   string                 `protobuf:"bytes,1,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"` // Текущий access токен
	OldPassword   string                 `protobuf:"bytes,2,opt,name=old_password,json=oldPassword,proto3" json:"old_password,omitempty"` // Старый пароль
	NewPassword   string                 `protobuf:"bytes,3,opt,name=new_password,json=newPassword,proto3" json:"new_password,omitempty"` // Новый пароль
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type TrackUserAccessRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AccessToken   string                 `protobuf:"bytes,1,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *TrackUserAccessRequest) Reset() {
	*x = TrackUserAccessRequest{}
	mi := &file_sso_sso_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TrackUserAccessRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrackUserAccessRequest) ProtoMessage() {}

func (x *TrackUserAccessRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrackUserAccessRequest.ProtoReflect.Descriptor instead.
func (*TrackUserAccessRequest) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{12}
}

func (x *TrackUserAccessRequest) GetAccessToken() string {
	if x != nil {
		return x.AccessToken
	}
	return ""
...
type GetUserAccessCountRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AccessToken   string                 `protobuf:"bytes,1,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetUserAccessCountRequest) Reset() {
	*x = GetUserAccessCountRequest{}
	mi := &file_sso_sso_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetUserAccessCountRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserAccessCountRequest) ProtoMessage() {}

func (x *GetUserAccessCountRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserAccessCountRequest.ProtoReflect.Descriptor instead.
func (*GetUserAccessCountRequest) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{13}
}

func (x *GetUserAccessCountRequest) GetAccessToken() string {
	if x != nil {
		return x.AccessToken
	}
	return ""
...
type GetUserAccessCountResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetUserAccessCountResponse) Reset() {
	*x = GetUserAccessCountResponse{}
	mi := &file_sso_sso_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetUserAccessCountResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserAccessCountResponse) ProtoMessage() {}

func (x *GetUserAccessCountResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserAccessCountResponse.ProtoReflect.Descriptor instead.
func (*GetUserAccessCountResponse) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{14}
}

func (x *GetUserAccessCountResponse) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x88, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52,
	...
	0x70, 0x49, 0x64, 0x22, 0x57, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70,
	...
	0x41, 0x64, 0x6d, 0x69, 0x6e, 0x22, 0x3a, 0x0a, 0x13, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x33, 0x0a, 0x0e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x95, 0x01, 0x0a, 0x0f, 0x53,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x17,
	0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x09, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x61, 0x64,
	0x6d, 0x69, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x41, 0x64, 0x6d,
	0x69, 0x6e, 0x22, 0x80, 0x01, 0x0a, 0x15, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x61, 0x73,
	...
	,
	...
	0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xca, 0x04, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12,
	...
	0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x35, 0x0a, 0x06, 0x4c,
	...
	0x74, 0x79, 0x12, 0x36, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x2e,
	0x61, 0x75, 0x74, 0x68, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x45, 0x0a, 0x0e, 0x43, 0x68,
	...
	,
}
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*SessionRequest)(nil),             // 9: auth.SessionRequest
	(*SessionResponse)(nil),            // 10: auth.SessionResponse
	(*ChangePasswordRequest)(nil),      // 11: auth.ChangePasswordRequest
	(*TrackUserAccessRequest)(nil),     // 12: auth.TrackUserAccessRequest
	(*GetUserAccessCountRequest)(nil),  // 13: auth.GetUserAccessCountRequest
	(*GetUserAccessCountResponse)(nil), // 14: auth.GetUserAccessCountResponse
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	9,  // 5: auth.Auth.Session:input_type -> auth.SessionRequest
	11, // 6: auth.Auth.ChangePassword:input_type -> auth.ChangePasswordRequest
	12, // 7: auth.Auth.TrackUserAccess:input_type -> auth.TrackUserAccessRequest
	13, // 8: auth.Auth.GetUserAccessCount:input_type -> auth.GetUserAccessCountRequest
	...
	7,  // 12: auth.Auth.RefreshToken:output_type -> auth.RefreshTokenResponse
	15, // 13: auth.Auth.Logout:output_type -> google.protobuf.Empty
	10, // 14: auth.Auth.Session:output_type -> auth.SessionResponse
	15, // 15: auth.Auth.ChangePassword:output_type -> google.protobuf.Empty
	15, // 16: auth.Auth.TrackUserAccess:output_type -> google.protobuf.Empty
	14, // 17: auth.Auth.GetUserAccessCount:output_type -> auth.GetUserAccessCountResponse
